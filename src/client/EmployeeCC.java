...
public class EmployeeCC {
	...
	public static File createFuelStationReports(int stationId, String companyName,
			StationManagerReportsTypes reportType, Quarter quarter, String year) {
		...
		if (MyFuelClient.ServerRetObj == null)
			return null;
	...
	/**
	 * The function create a new message to the server which contains ArrayList of
	 * string that represent customers
	 * 
	 * @param upCutomer
	...
	/**
	 * The function create a new message to the server which contains
	 * arrayList<object> - id, purchase model, company name
	 * 
	 * @param id
	 * @param purchaseM
	 * @param companyNames
	...
	/**
	 * The function create a new message to the server which contains
	 * arrayList<object> - car and old car
	 * 
	 * @param car
	 * @param oldCar
	 * @return boolean
	...
	public static float getFuelAmountByFuelType(String fuelType, int stationId) {
		...
		params.add(fuelType);
		params.add(stationId);
		ClientUI.client.accept(new Message(params, Commands.getFuelAmountByFuelType));
	...
	public static int getFuelTanksizebyType(String fuelType, int stationId) {
		...
		params.add(fuelType);
		params.add(stationId);
		ClientUI.client.accept(new Message(params, Commands.getFuelTanksizebyType));
		return (int) MyFuelClient.ServerRetObj;
	}
	
	public static void createOrder(String fuelType, int stationId) {
		ArrayList<Object> params = new ArrayList<Object>();
		params.add(fuelType);
		params.add(stationId);
		ClientUI.client.accept(new Message(params, Commands.createOrder));
	}
}
